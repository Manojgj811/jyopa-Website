                                ...
                                success: function(msg) { 
                                    ...
                                    for (var i = 0; i < count; i++) {
                                        ...
                                        $.ajax({
                                            ...
                                            data: '{"candidateId":"'+msg[i]['candidate_id']+'"}',
                                            success: function(msg) {
                                                msg1 = JSON.stringify(msg);
       ...
       // }
        $.ajax({
            ...
            headers: {
                ...
                "Authorization": readCookie('emp_sessionId')
            },
            url: "/emppostjob/",
           // data: "{\n\t\"jobTitle\":\"" + jobTitle + "\",\n\t\"jobDescription\":\"" + jobDescription + "\",\n\t\"jobCity\":\"" + jobCity + "\",\n\t\"jobState\":\"" + jobState + "\",\n\t\"jobCountry\":\"" + jobCountry + "\",\n\t\"jobIndustry\":\"" + jobIndustry + "\",\n\t\"jobSalary\":\"" + jobSalary + "\",\n\t\"jobExperience\":\"" + jobExperience + "\",\n\t\"jobType\":\"" + jobType + "\",\n\t\"jobStatus\":\"active\",\n\t\"jobQualifications\":[\"" + jobQualifications + "\"],\n\t\"jobSkills\":[\"" + jobSkills + "\"]\n}\t",
            data: '{"jobTitle":"'+ jobTitle +'","jobDescription":"'+ jobDescription +'","jobCity":"'+ jobCity +'","jobState":"'+ jobState +'","jobCountry":"'+ jobCountry +'","jobIndustry":"'+ jobIndustry +'","jobSalary":"'+ jobSalary +'","jobExperience":"'+ jobExperience +'","jobType":"'+ jobType +'","jobStatus":"active","jobQualifications": ["'+ jobQualifications +'"],"jobSkills": ["'+ jobSkills +'"]}',
