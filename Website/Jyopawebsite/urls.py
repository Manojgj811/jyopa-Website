...
urlpatterns = [
    ...
    path('getResumes/',test.getResumes,name='getResumes'),
    path('getResumeData/',test.getResumeData,name='getResumeData'),
    path('extractResumeData/',test.extractResumeData,name='extractResumeData'),
